      ...
      <div className="lg:col-span-1">
        <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200 sticky top-24">
          ...
          <button
            ...
            className="w-full bg-biker-yellow hover:bg-biker-yellowHover text-biker-black font-bold py-4 rounded-full uppercase tracking-wider transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
