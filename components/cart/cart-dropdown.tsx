  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-3 hover:bg-biker-gray/10 rounded-full transition-colors text-biker-black"
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="fixed md:absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto right-auto md:right-0 top-20 md:top-auto mt-0 md:mt-2 w-[90vw] max-w-sm md:w-96 ml-3 md:ml-0 bg-white rounded-lg shadow-2xl z-50 border-2 border-white md:border-gray-200">
            ...
            <>
              ...
              <div className="p-4 bg-gray-50 border-t-2 border-gray-200">
                ...
                <button
                  ...
                  className="btn-primary w-full bg-biker-yellow hover:bg-biker-black text-biker-black hover:text-biker-yellow border-2 border-biker-yellow font-bold py-3 rounded-full uppercase tracking-wider transition-all text-center"
                >
                  Naar Checkout
                </button>
