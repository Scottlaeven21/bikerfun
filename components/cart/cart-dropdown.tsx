...
export function CartDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="fixed md:absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto right-auto md:right-0 top-20 md:top-auto mt-0 md:mt-2 w-[90vw] max-w-sm md:w-96 ml-16 md:ml-0 bg-white rounded-lg shadow-2xl z-50 border-2 border-white md:border-gray-200">
