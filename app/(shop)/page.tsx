...
export default function HomePage() {
  return (
    <div>
      ...
      <section className="py-20 bg-gradient-to-b from-black via-biker-black/10 to-black">
      ...
      {/* Over Ons Section */}
      <section className="py-20 bg-gradient-to-b from-black via-biker-black/10 to-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Contact CTA Section */}
      <section className="py-16 bg-gradient-to-b from-black via-biker-black/10 to-black border-y-4 border-biker-yellow/30">
