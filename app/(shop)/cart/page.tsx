            ...
            <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-6 sticky top-32">
              ...
              <div className="mt-6 pt-6 border-t-2 border-gray-200">
                ...
                <div className="flex items-center space-x-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="90" height="36" viewBox="0 0 98.5 28">
                    <path fill="#0A2540" d="M34.5 6.7h3.7v11h-3.7zM48.1 6.7v11h-3.4v-1.3c-.8 1-2 1.7-3.6 1.7-3.1 0-5.7-2.6-5.7-5.9s2.5-5.9 5.7-5.9c1.5 0 2.9.6 3.6 1.7V6.7zm-9 5.5c0 1.6 1.3 3 3 3s3-1.3 3-3-1.3-3-3-3-3 1.3-3 3zm-22.7-5.5c1.5 0 2.9.6 3.6 1.7V6.7h3.4v11h-3.4v-1.3c-.8 1-2 1.7-3.6 1.7-3.1 0-5.7-2.6-5.7-5.9s2.6-5.9 5.7-5.9zm.4 8.8c1.7 0 3-1.3 3-3s-1.3-3-3-3-3 1.3-3 3 1.3 3 3 3z"/>
                    <path fill="#0A2540" d="M54.5 17.7c-3.1 0-5.7-2.6-5.7-5.9s2.5-5.9 5.7-5.9c1.5 0 2.9.6 3.6 1.7V6.7h3.4v11h-3.4v-1.3c-.8 1-2.1 1.7-3.6 1.7zm.4-3c1.7 0 3-1.3 3-3s-1.3-3-3-3-3 1.3-3 3 1.3 3 3 3zM65.5 6.7v11h-3.7v-11zM67.6 6.7v11h-3.7v-11z"/>
                    <path fill="#0A2540" d="M72.5 0c-6.2 0-11.2 5-11.2 11.2s5 11.2 11.2 11.2 11.2-5 11.2-11.2S78.7 0 72.5 0z"/>
                    <path fill="#213B4C" d="M16.4 6.5c1.5 0 2.9.6 3.6 1.7V6.5h3.4v11h-3.4v-1.3c-.8 1-2 1.7-3.6 1.7-3.1 0-5.7-2.6-5.7-5.9s2.6-5.9 5.7-5.9zm.4 8.8c1.7 0 3-1.3 3-3s-1.3-3-3-3-3 1.3-3 3 1.3 3 3 3zM4.3 6.5c1.5 0 2.9.6 3.6 1.7V6.5h3.4v13.8H7.9v-4.4c-.8 1-2 1.7-3.6 1.7C1.2 17.5-.3 14.9-.3 11.6s2.6-5.9 5.7-5.9zm.4 8.8c1.7 0 3-1.3 3-3s-1.3-3-3-3-3 1.3-3 3 1.3 3 3 3z"/>
                  </svg>
                </div>
              </div>
            </div>
