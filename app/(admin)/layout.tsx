  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex">
        {/* Sidebar */}
        <aside className="w-64 bg-gradient-to-b from-black to-gray-900 text-white min-h-full border-r border-gray-800">
          <div className="p-6">
            <h2 className="text-xl font-bold mb-6 text-biker-yellow font-['Inter']">Admin Panel</h2>
            <nav className="space-y-2">
              <Link
                href="/admin"
                className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-biker-yellow/10 transition-all group"
              >
